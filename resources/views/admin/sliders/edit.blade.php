...
@section('content')
    <div class="-mx-2 sm:-mx-4">
        <div class="mb-6 px-2 sm:px-4">
            <h1 class="text-xl sm:text-2xl font-semibold text-gray-100">Edit Slider</h1>
            <p class="text-sm text-gray-400 mt-1">Update slider content and image.</p>
        </div>
            ...
            <form action="{{ route('admin.sliders.update', $slider) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="subtitle" name="subtitle" value="{{ old('subtitle', $slider->subtitle) }}" placeholder="Optional subtitle"
                               class="w-full rounded-lg border border-gray-700 bg-gray-900 text-sm text-gray-100 placeholder:text-gray-500 px-3 py-2 focus:ring-emerald-500 focus:border-emerald-500">
                ...
                <div class="mt-5">
                    ...
                    <textarea id="description" name="description" rows="3" placeholder="Optional description"
                              class="w-full rounded-lg border border-gray-700 bg-gray-900 text-sm text-gray-100 placeholder:text-gray-500 px-3 py-2 focus:ring-emerald-500 focus:border-emerald-500">{{ old('description', $slider->description) }}</textarea>
                ...
                <div class="mt-5 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                    <div>
                        ...
                        <input type="text" id="link" name="link" value="{{ old('link', $slider->link) }}" placeholder="https://..."
                               class="w-full rounded-lg border border-gray-700 bg-gray-900 text-sm text-gray-100 placeholder:text-gray-500 px-3 py-2 focus:ring-emerald-500 focus:border-emerald-500">
                    ...
                    <div>
                        ...
                        <input type="text" id="link_text" name="link_text" value="{{ old('link_text', $slider->link_text) }}" placeholder="Shop Now"
                               class="w-full rounded-lg border border-gray-700 bg-gray-900 text-sm text-gray-100 placeholder:text-gray-500 px-3 py-2 focus:ring-emerald-500 focus:border-emerald-500">
                ...
                <div class="mt-5">
                    <label for="image" class="block text-xs font-semibold text-gray-300 mb-1.5">Slider Image</label>
                    @if($slider->image)
                        <div class="mb-3 flex items-center gap-4">
                            <img src="{{ $slider->image_url }}" alt="{{ $slider->title }}" class="w-32 h-20 object-cover rounded-lg border border-gray-700">
                            <span class="text-xs text-gray-400">Current image. Upload new to replace.</span>
                        </div>
                    @endif
                    <div class="flex justify-center rounded-xl border-2 border-dashed border-gray-600 bg-gray-900/50 px-6 py-10 hover:border-gray-500 transition-colors">
                        <div class="text-center">
                            ...
                            <div class="mt-4 flex flex-col sm:flex-row gap-2 justify-center">
                                ...
                                <span class="text-xs text-gray-400 self-center">PNG, JPG, GIF, WebP up to 2MB (optional)</span>
                            </div>
                ...
                <div class="mt-5 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                    <div>
                        ...
                        <input type="text" id="bg_class" name="bg_class" value="{{ old('bg_class', $slider->bg_class) }}" placeholder="e.g. bg-gradient-to-r from-blue-600 to-purple-600"
                               class="w-full rounded-lg border border-gray-700 bg-gray-900 text-sm text-gray-100 placeholder:text-gray-500 px-3 py-2 focus:ring-emerald-500 focus:border-emerald-500">
                    ...
                    <div>
                        ...
                        <input type="number" id="sort_order" name="sort_order" min="0" value="{{ old('sort_order', $slider->sort_order) }}"
                ...
                <div class="mt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
                    <div class="flex items-center gap-3">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            ...
                            <input type="checkbox" name="is_active" value="1" class="sr-only peer" {{ old('is_active', $slider->is_active) ? 'checked' : '' }}>
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <button type="submit" class="px-5 py-2.5 rounded-lg bg-blue-600 text-xs sm:text-sm font-semibold text-white hover:bg-blue-500 shadow-lg shadow-blue-500/30">Update Slider</button>
                    </div>
                </div>
            </form>
        </div>
