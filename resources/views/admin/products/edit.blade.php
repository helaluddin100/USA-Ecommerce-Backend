            ...
            <form action="{{ route('admin.products.update', $product) }}" method="POST">
                ...
                <div class="mt-5 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                    <div>
                        ...
                        <input type="text" id="image" name="image" value="{{ old('image', $product->image) }}" placeholder="e.g. 🎧 or image URL"
                               class="w-full rounded-lg border border-gray-700 bg-gray-900 text-sm text-gray-100 placeholder:text-gray-500 px-3 py-2 focus:ring-emerald-500 focus:border-emerald-500">
                ...
                <div class="mt-5">
                    ...
                    <textarea id="description" name="description" rows="4" placeholder="Enter product description"
                              class="w-full rounded-lg border border-gray-700 bg-gray-900 text-sm text-gray-100 placeholder:text-gray-500 px-3 py-2 focus:ring-emerald-500 focus:border-emerald-500">{{ old('description', $product->description) }}</textarea>
